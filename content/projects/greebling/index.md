...
![Greebles](Workshop-design-outcomes.png)
![Blender Nodes](Blender-Scatter-Greebles-Geo-Nodes.png)
...
<!-- Stub page — no source material yet. Add a description, process detail, and photos here.
     ...
     filename, e.g. ![Greebling](photo.jpg). Set draft = false above once it's ready to publish. -->
